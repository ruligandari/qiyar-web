...
<div class="container-fluid">
  ...
  <?php if (session()->getFlashdata('success')) : ?>
    <script>
      Swal.fire({
        ...
        window.location = "<?= base_url('dashboard/pemasukan-broadcast') ?>";
      });
    </script>
  <?php endif ?>
  ...
  <div class="card shadow mb-4">
    <div class="card-header py-3">
      ...
      <div class="card-body">
        <form method="POST" class="dropzone" id="fileDrop" action="<?= base_url('dashboard/broadcast/pemasukan-broadcast/add')  ?> " enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="formGroupExampleInput" name="bank_tujuan" placeholder="Masukan Bank Tujuan" required>
          </div>
          <div class="form-group">
