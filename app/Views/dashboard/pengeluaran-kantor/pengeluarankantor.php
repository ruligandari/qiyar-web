...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Pengeluaran Kantor</h1>
    </div>
    <!-- DataTales Example -->
...
<script>
    ...
    $(document).ready(function() {
        let table = $('#table').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: '<?= base_url('dashboard/advertiser/pengeluaran-kantor/list-pengeluaran-kantor') ?>',
                method: 'POST',
                data: function(d) {
            ...
            buttons: [{
                    extend: 'excelHtml5',
                    footer: true,
                    title: 'Data Pengeluaran Kantor - ' + formattedDate,
                    exportOptions: {
    ...
    function deleteRecord(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?= base_url('dashboard/advertiser/pengeluaran-kantor/delete') ?>",
                    data: {
                        id: id
                    },
