...
<div class="container-fluid">
  ...
  <div class="card shadow mb-4">
    <div class="card-header py-3">
      ...
      <div class="card-body">
        <form method="POST" class="dropzone" id="fileDrop" action="<?= base_url('dashboard/advertiser/pemasukan-advertiser/update') ?>" enctype="multipart/form-data">
          ...
          <div class="form-group">
            <p class="text-hidden">Bukti Upload Sebelumnya: <a href="<?= base_url('bukti_pemasukan_advertiser/') . $data['upload_bukti'] ?>"><?= $data['upload_bukti'] ?></a></p>
          </div>
        </form>
      </div>
    </div>
