...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Data Tambah Stok Warehouse Kuningan</h1>
    </div>
    <!-- DataTales Example -->
    <div class="row">
        <div class="col-xl-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6 d-flex justify-content-end">
                                <?php if (in_array(session()->get('role'), ['2', '3', '6'])) : ?>
                                    <a href="<?= base_url('dashboard/warehouse-kuningan/stok/tambah') ?>" class="d-none d-sm-inline-block btn btn-sm btn-success shadow-sm"><i class="fas fa-plus fa-sm text-white-50"></i> Tambah Stok Produk</a>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
