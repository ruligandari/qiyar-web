...
<div class="container-fluid">
  ...
  <div class="card shadow mb-4">
    ...
    <div class="card-body">
      <form method="POST" class="dropzone" id="fileDrop" action="<?= base_url('dashboard/warehouse-kuningan/keluar/update') ?>" enctype="multipart/form-data">
        ...
        <input type="text" value="<?= $data['bukti_pickup'] ?> " name="bukti_transfer_lama" hidden>
        <button type="submit" class="btn btn-primary">Submit</button>
        <div class="form-group">
          <p class="text-hidden">Bukti Upload Sebelumnya: <a href="<?= base_url('bukti-barang-masuk-kng/') . $data['bukti_pickup'] ?>"><?= $data['bukti_pickup'] ?></a></p>
        </div>
      </form>
    </div>
  </div>
