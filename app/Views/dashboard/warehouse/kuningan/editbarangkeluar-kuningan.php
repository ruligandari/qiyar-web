...
<div class="container-fluid">
  ...
  <div class="card shadow mb-4">
    <div class="card-header py-3">
      ...
      <div class="card-body">
        <form method="POST" action="<?= base_url('dashboard/warehouse-kuningan-keluar/update') ?>" enctype="multipart/form-data">
          ...
          <div class=" form-group">
            ...
            <?php if ($data['bukti_pickup'] != null) : ?>
              <p>Bukti Sebelumnya: <a href="<?= base_url('bukti-barang-masuk-kng/') . $data['bukti_pickup'] ?>"><?= $data['bukti_pickup'] ?></a></p>
            <?php endif; ?>
            <br>
