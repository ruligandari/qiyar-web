                    ...
                    <div class="">
                        <div class="row">
                            ...
                            <div class="col-xl-6 d-flex justify-content-end">
                                <?php if (session()->get('role') == '1' || session()->get('role') == '7') : ?>
                                ...
                                foreach ($barangmasuk as $data) : ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a class="btn btn-success" title="Edit Bray" href="<?= base_url('dashboard/warehouse-jakarta/edit/') . $data['id'] ?>" role="button"><i class="fas fa-sm fa-pen"></i></a>
                                            <button class="btn btn-danger delete-button-kng" title="Hapus Bray" data-id="<?= $data['id'] ?>" data-url="<?= base_url('dashboard/warehouse-jakarta/delete') ?>" role="button"><i class="fas fa-sm fa-trash"></i></i></button>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
                            ...
                            <tbody>
                                ...
                                foreach ($barangkeluar as $data) : ?>
                                    <tr>
                                        ...
                                        <td><a href="<?= base_url('bukti-barang-masuk-jkt/') . $data['bukti_pickup'] ?>" target="_blank">
                                                <img src="<?= base_url('bukti-barang-masuk-jkt/') . $data['bukti_pickup'] ?>" alt="" style="height:50px; width:50px"></a></td>
                                        <td class="text-center">
                                            <a class="btn btn-success" title="Edit Bray" href="<?= base_url('dashboard/warehouse-jakarta/keluar/edit/') . $data['id'] ?>" role="button"><i class="fas fa-sm fa-pen"></i></a>
                                            <button class="btn btn-danger delete-button-kng-keluar" title="Hapus Bray" data-id="<?= $data['id'] ?>" data-url="<?= base_url('dashboard/warehouse-jakarta/keluar/delete') ?>" role="button"><i class="fas fa-sm fa-trash"></i></i></button>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
