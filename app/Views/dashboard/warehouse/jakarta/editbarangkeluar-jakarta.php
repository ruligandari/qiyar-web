...
<div class="container-fluid">
  ...
  <div class="card shadow mb-4">
    ...
    <div class="card-body">
      <form method="POST" class="dropzone" id="fileDrop" action="<?= base_url('dashboard/warehouse-jakarta/keluar/update') ?>" enctype="multipart/form-data">
        ...
        <div class="form-group">
          <p class="text-hidden">Bukti Upload Sebelumnya: <a href="<?= base_url('bukti-barang-masuk-jkt/') . $data['bukti_pickup'] ?>"><?= $data['bukti_pickup'] ?></a></p>
        </div>
      </form>
    </div>
  </div>
