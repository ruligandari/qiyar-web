      ...
      <div class="card-body">
        <form method="POST" action="<?= base_url('dashboard/pengeluaran-kantor/add')  ?> " enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="formGroupExampleInput" name="total_pengeluaran_adv" placeholder="Masukan Bank Tujuan">
          </div>
          <div class="form-group">
            <label for="formGroupExampleInput">Total Pemasukan Advertiser</label>
            <input type="text" class="form-control" id="formGroupExampleInput" name="total_pemasukan_adv" placeholder="Masukan Bank Tujuan">
          </div>
          <div class="form-group">
            <label for="formGroupExampleInput">Total</label>
            <input type="text" class="form-control formatted-input" id="harga" name="total" placeholder="Masukan Jumlah">
          </div>
