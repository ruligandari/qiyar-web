...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Tutup Buku Kantor</h1>
    </div>
    <!-- DataTales Example -->
        ...
        <div class="card-header py-3">
            <div class="">
                <div class="d-sm-flex align-items-center justify-content-between">
                    <h6 class=" font-weight-bold text-primary">Data Tutup Buku Kantor</h6>
                    <?php if (session()->get('role') == '1') : ?>
                        <a href="<?= base_url('dashboard/tutup-buku/tambah') ?>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-plus fa-sm text-white-50"></i> Tambah Data</a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
                ...
                <table class="table table-bordered" id="example1" width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            <th>No</th>
                            <th>Tanggal</th>
                            <th>Total Pengeluaran Advertiser</th>
                            <th>Total Pemasukan Advertiser</th>
                            <th>Total</th>
                            <?php if (session()->get('role') == '1') : ?>
                                <th>Aksi</th>
                            <?php endif; ?>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                <td><?= $no++ ?></td>
                                <td><?= $data['tanggal'] ?></td>
                                <td><?= number_format($data['total_pengeluaran_adv'], 0, ',', '.') ?>
                                <td><?= number_format($data['total_pemasukan_adv'], 0, ',', '.') ?>
                                <td><?= number_format($data['total'], 0, ',', '.') ?>
                                </td>
                                <?php if (session()->get('role') == '1') : ?>
                                    <td class="text-center">
                                        <a class="btn btn-success" title="Edit Bray" href="<?= base_url('dashboard/tutup-buku/edit/') . $data['id'] ?>" role="button"><i class="fas fa-sm fa-pen"></i></a>
