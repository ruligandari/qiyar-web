    ...
    <?php if (session()->getFlashdata('success')) : ?>
        <script>
            Swal.fire({
                position: 'center',
                icon: 'success',
                text: 'Terima Kasih, Anda akan segera dihubungi oleh HRD kami',
        ...
        <section id="portfolio-details" class="portfolio-details">
            <div class="container" data-aos="fade-up">
                ...
                <form method="POST" action="<?= base_url('tambah-lamaran') ?>" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">Upload CV <b style="color: red">*</b></label>
                        <input type="file" name="cv" class="form-control" aria-label="file example" required />
